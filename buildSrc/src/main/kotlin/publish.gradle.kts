        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/susyimes/cryptoworld/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/susyimes/cryptoworld.git")
                        developerConnection.set("scm:git:ssh://github.com/susyimes/cryptoworld.git")
                        url.set("https://github.com/susyimes/cryptoworld/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/susyimes/cryptoworld/issues")
                    }
                }
            }
        }
